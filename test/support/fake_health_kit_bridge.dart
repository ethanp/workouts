...
class FakeHealthKitBridge({
  var HealthPermissionStatus status = HealthPermissionStatus.unknown,
  var HealthPermissionStatus requestedStatus =
      HealthPermissionStatus.authorized,
}) extends HealthKitBridge {
