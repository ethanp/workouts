...
CREATE TABLE cardio_workouts (
    ...
    device_model TEXT,
    device_name TEXT,
    elevation_ascended_meters DOUBLE PRECISION,
    recovery_bpm DOUBLE PRECISION,
    effort_score DOUBLE PRECISION,
    estimated_effort_score DOUBLE PRECISION,
    machine_linked BOOLEAN NOT NULL DEFAULT false,
